...
/**
 * Class VOcuavlocAvailable
 */
public class VOcuavlocAvailable extends BaseModel implements Serializable {
	...
	@JsonProperty("offenderVisitId")
	private Integer offenderVisitId;
	
	/**
	 * @return the offenderVisitId
	 */
	public Integer getOffenderVisitId() {
		return offenderVisitId;
	}

	/**
	 * @param offenderVisitId the offenderVisitId to set
	 */
	public void setOffenderVisitId(final Integer offenderVisitId) {
		this.offenderVisitId = offenderVisitId;
	}

	public VOcuavlocAvailable() {
		// VOcuavlocAvailable
	}
