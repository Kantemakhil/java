...
/**
 * Class RgFromAgyLocIdBean
 * @author Vrnda Software Technologies 
 * @version 1.0 
 */
public class RgFromAgyLocIdBean extends BaseModel implements Serializable {
	...
	*/
	...
	public String toString() {
	 return "{agyLocId="+agyLocId+",description="+description+",icrggq0="+icrggq0+"}";
	}
}
