...
build_war() {
  ...
  if [ "${CIRCLECI}" == "" ]; then
	...
	mvn install:install-file -Dfile=./support_libs/syncfusion-ej2-spellchecker-25.1.35.jar -DgroupId=com.syncfusion -DartifactId=syncfusion-ej2-spellchecker -Dversion=25.1.35 -Dpackaging=jar
	mvn install:install-file -Dfile=./support_libs/syncfusion-licensing-25.1.35.jar -DgroupId=com.syncfusion -DartifactId=syncfusion-licensing -Dversion=25.1.35 -Dpackaging=jar
	mvn install:install-file -Dfile=./support_libs/syncfusion-javahelper-25.1.35.jar -DgroupId=com.syncfusion -DartifactId=syncfusion-javahelper -Dversion=25.1.35 -Dpackaging=jar
	mvn install:install-file -Dfile=./support_libs/syncfusion-ej2-wordprocessor-25.1.35.jar -DgroupId=com.syncfusion -DartifactId=syncfusion-ej2-wordprocessor -Dversion=25.1.35 -Dpackaging=jar
	mvn install:install-file -Dfile=./support_libs/syncfusion-docio-25.1.35.jar -DgroupId=com.syncfusion -DartifactId=syncfusion-docio -Dversion=25.1.35 -Dpackaging=jar
	mvn install:install-file -Dfile=./support_libs/jasperreports-6.15.0.jar -DgroupId=net.sf.jasperreports -DartifactId=jasperreports -Dversion=6.15.0 -Dpackaging=jar
	mvn install:install-file -Dpackaging=pom -Dfile=./support_libs/jasperreports-6.15.0.pom -DpomFile=./support_libs/jasperreports-6.15.0.pom
	...
	mvn install:install-file -Dfile=./support_libs/aspose-pdf-19.7-jdk17.jar -DgroupId=com.aspose -DartifactId=aspose-pdf -Dversion=19.7 -Dpackaging=jar
  else
    mvn install:install-file -Dfile=./support_libs/ojdbc7.jar -DgroupId=com.oracle -DartifactId=ojdbc7 -Dversion=12.1.0.2 -Dpackaging=jar
	mvn install:install-file -Dfile=./support_libs/syncfusion-ej2-spellchecker-25.1.35.jar -DgroupId=com.syncfusion -DartifactId=syncfusion-ej2-spellchecker -Dversion=25.1.35 -Dpackaging=jar
	mvn install:install-file -Dfile=./support_libs/syncfusion-licensing-25.1.35.jar -DgroupId=com.syncfusion -DartifactId=syncfusion-licensing -Dversion=25.1.35 -Dpackaging=jar
