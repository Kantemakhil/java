...
/**
 * The persistent class for the OFFENDER_SENTENCE_TERMS database table.
 * 
 */
public class OffenderSentenceTerm extends BaseModel implements Serializable {
