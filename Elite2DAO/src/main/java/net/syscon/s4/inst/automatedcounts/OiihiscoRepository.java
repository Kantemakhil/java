...
/**
 * Interface OiihiscoRepository
 */
public interface OiihiscoRepository {
	...
	List<AgencyLocationCounts> agencyLocationCountsExecuteQuery(AgencyLocationCounts objAgencyLocationCounts);

	List<AgencyCounts> agencyCountsExecuteQuery(AgencyCounts searchBean);

	String getLocationDesc(Integer reportingLocId, Integer agySeq);

	List<AgencyCountTypes> getCountIdAndTime(Integer countTypeId);
	
	String getRecountComment(Integer reportingLocId);
