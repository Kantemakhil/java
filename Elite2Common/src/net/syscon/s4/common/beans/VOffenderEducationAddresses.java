...
@XmlRootElement
public class VOffenderEducationAddresses extends BaseModel {
	...
	public VOffenderEducationAddresses() {
		// VOffenderEducationAddresses
	}
	...
	/**
	 * @param streetIinformation
	 *            the streetIinformation to set
	 */
	public void setStreetIinformation(String streetInformation) {
