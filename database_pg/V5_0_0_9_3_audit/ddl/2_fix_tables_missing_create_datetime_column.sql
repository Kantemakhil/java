----------------------------------------------------------------------------------------------------------------
--tables that do not have column create_datetime: addresses_jn, offender_deductions_jn, offenders_jn, orders_jn
--none will be fixed, these are all journal tables
----------------------------------------------------------------------------------------------------------------
/*
