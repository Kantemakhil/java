...
public class OffenderDrugAdmDrug extends BaseModel implements Serializable {
	...
	@JsonProperty("offenderDrugAdmission")
	private OffenderDrugAdmission offenderDrugAdmission;
	 ...
	 * @return
	 */
	public OffenderDrugAdmission getOffenderDrugAdmission() {
		return offenderDrugAdmission;
	}

	/**
	 *
	 * @param offenderDrugAdmission
	 */
	public void setOffenderDrugAdmission(OffenderDrugAdmission offenderDrugAdmission) {
		this.offenderDrugAdmission = offenderDrugAdmission;
	}
