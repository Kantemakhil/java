...
public class OffenderSubAcShadows extends BaseModel implements Serializable {
	...
	private String trustAccountCode;

	/**
	 * Creates new OffenderSubAcShadows class Object
	 */
	public OffenderSubAcShadows() {
	 ...
	 */
	public String getTrustAccountCode() {
	 ...
	 */
	public void setTrustAccountCode(String trustAccountCode) {
