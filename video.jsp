...
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <title>Syscon Justice System</title>
    ...
    <body>
        <div id="wrapper">
			...
			<iframe src="https://player.vimeo.com/video/<%= request.getParameter("vurlId")%>" width="100%" height="100%" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
