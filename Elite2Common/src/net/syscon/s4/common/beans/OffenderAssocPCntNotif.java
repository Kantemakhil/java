...
public class OffenderAssocPCntNotif extends BaseModel implements Serializable {
	...
	@JsonProperty("offenderAssocPrtyContact")
	private OffenderAssocPrtyContact offenderAssocPrtyContact;
	 ...
	 * @return
	 */
	public OffenderAssocPrtyContact getOffenderAssocPrtyContact() {
		return offenderAssocPrtyContact;
	}

	/**
	 *
	 * @param offenderAssocPrtyContact
	 */
	public void setOffenderAssocPrtyContact(OffenderAssocPrtyContact offenderAssocPrtyContact) {
		this.offenderAssocPrtyContact = offenderAssocPrtyContact;
	}
