OFFENDER_SENTENCES_T4_OFFENDER_SENTENCES{
...
OFFENDER_SENTENCES_T4_INSERT{
insert into offender_assoc_p_event_notifs(trg_event_id,event_date,offender_book_id,notification_code,create_datetime,modify_datetime,create_user_id)values ( :trgEventId,:eventDate, :offenderBookId, 'DISCH_CS',:createDatetime,:modifyDatetime,:createUserId)
}
OFFENDER_SENTENCES_T4_L_TRG_EVENT_ID{
